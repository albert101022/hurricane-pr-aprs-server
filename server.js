...
function connect() {
  ...
  client.connect(APRS_PORT, APRS_HOST, () => {
    ...
    console.log('[APRS] Login sent');
    setTimeout(() => {
      client.write('#filter b/KP4GA/KP4FJC/DW5492/FW8412/FW8644/GW4841/GW5186/KP4OZ/WP3OF-1/WP4PW/WP3XM/FW2480/FW4300/FW7712/GW6493/CW9754/EW7791/FW4325/FW8269/GW5647/GW5857/GW5869/GW5988/GW7025/WP3OF/WP3OF-5/CW8756/DW0435/DW8435/EW9889/FW2250/FW2454/FW8993/GW0536/GW0931/GW1345/GW4429/GW4457/GW5402/GW6997/GW7070/GW5985/WP3OF-2/CW8822/EW6246/EW6754/GW0907/GW5842/GW5997/GW6435/GW6960/GW6961/GW6979\r\n');
      console.log('[APRS] Buddy filter sent for', 53, 'stations');
    }, 500);
  });
  ...
  client.on('data', (chunk) => {
    ...
    lines.forEach(line => {
      ...
      if (packetsReceived <= 10) console.log('[RAW]', line.substring(0, 120));
      const parsed = parseAPRSWeather(line);
      if (parsed) {
        recentCallsigns.add(parsed.id);
        if (recentCallsigns.size > 200) recentCallsigns.clear();
        // Store all parsed stations (debug mode - identify real PR station IDs)
        stationData[parsed.id] = parsed;
        if (Object.keys(stationData).length > 200) {
          const oldest = Object.keys(stationData)[0];
          delete stationData[oldest];
        }
      }
    });
  });
