...
function connect() {
  ...
  client.connect(APRS_PORT, APRS_HOST, () => {
    ...
    setTimeout(() => {
      client.write('#filter b/KP4GA/KP4FJC/DW5492/FW8412/FW8644/GW4841/GW5186/KP4OZ/WP3OF-1/WP4PW\r\n');
      client.write('#filter b/WP3XM/FW2480/FW4300/FW7712/GW6493/CW9754/EW7791/FW4325/FW8269/GW5647\r\n');
      client.write('#filter b/GW5857/GW5869/GW5988/GW7025/WP3OF/WP3OF-5/CW8756/DW0435/DW8435/EW9889\r\n');
      client.write('#filter b/FW2250/FW2454/FW8993/GW0536/GW0931/GW1345/GW4429/GW4457/GW5402/GW6997\r\n');
      client.write('#filter b/GW7070/GW5985/WP3OF-2/CW8822/EW6246/EW6754/GW0907/GW5842/GW5997/GW6435\r\n');
      client.write('#filter b/GW6960/GW6961/GW6979\r\n');
      console.log('[APRS] Buddy filters sent for 53 stations');
    }, 500);
  });
  ...
  client.on('data', (chunk) => {
    ...
    lines.forEach(line => {
      ...
      if (packetsReceived <= 20) console.log('[RAW]', line.substring(0, 150));
